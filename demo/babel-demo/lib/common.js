...
axios.defaults.baseURL = 'http://localhost:9000/'; //请求超时时间
...
axios.interceptors.response.use(function (response) {
  var code = response.data.code; //状态码
...
var AxiosUtil = function AxiosUtil(options) {
  var _this = this;
  ...
  options = Object.assign({
    ...
    //成功回调
    error: function error(_error) {} //错误回调
...
Vue.directive('has-permission', {
  bind: function bind(el, binding, vnode) {
    var permissionList = permissionData.permission;
