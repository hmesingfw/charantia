    ...
    data() {
        return {
            ...
            tableParams: [
                ...
                {
                    prop: 'isFree', width: 80,
                    labelF: () => <generate-label label='收费' data-key='isFree' option='statusList2' params={this.QueryParam} callback={this.query}></generate-label>,
                    formatF: row => <c-switch data={row} data-key="isFree" url={this.apiUrl} callback={this.query} configtitle="switchValue2"></c-switch>
                },
