    ...
    <dialog-alert v-model="value" title="资讯信息" width="500px" @submit="handleUpdate" :loading-button="loadingButton" @colse="colse" :isColse="false" @changeLoadingButton="loadingButton = false">
        <el-form label-position="right" label-width="50px" :rules="rules" :model="form" ref="ruleForm">
            ...
            <el-form-item label="描述" prop="description">
                <el-input type="textarea" :rows="6" v-model="form.description" maxlength="255" show-word-limit></el-input>
            </el-form-item>

            <el-form-item label="发布时间" prop="postTime">
                <el-date-picker v-model="form.postTime" type="datetime" placeholder="选择日期时间" format="yyyy-MM-dd mm:HH:ss"></el-date-picker>
            </el-form-item>
