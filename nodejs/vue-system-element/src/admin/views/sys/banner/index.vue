...
export default {
    ...
    data() {
        return {
            ...
            tableParams: [
                {
                    prop: 'posCode', label: '位置标识',
                },
                {
                    prop: 'title', label: '位置名称',
                },
                {
                    prop: 'width', label: '宽度',
                },
                ...
                },
                {
                    ...
                    formatF: row => <div><el-button type="text" on-click={() => this.handleEdit(row, 'put')} icon="el-icon-edit">编辑</el-button>
                        <el-button type="text" on-click={() => this.HandleDelete(this.apiUrl, row, this.query, { idKey: 'posCode' })} icon="el-icon-delete">删除</el-button> </div>
                },],
            tableLoading: false,
    ...
    methods: {
        ...
        /* 编辑 */
        handleEdit(row = { status: 1, sort: 1 }, requestType = 'post') {
