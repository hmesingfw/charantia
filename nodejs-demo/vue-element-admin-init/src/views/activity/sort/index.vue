    ...
    <div>
        ...
        <div class="margin-8 el-card el-card is-always-shadow">
            ...
            >
                ...
                <el-table-column prop="title" label="类型名称" show-overflow-tooltip></el-table-column>
            ...
            <dialog-alert v-model="dialogValue" title="信息录入" width="40%" :type="requestType" @submit="handleUpdate" :loading-button="loadingButton" @changeLoadingButton="loadingButton = false">
...
export default {
    ...
    methods: {
        ...
        query(flag) {
            ...
            this.$http.get(api.sys.eventCategory, { params: param }).then(res => {
        ...
        async handleUpdate() {
            this.$refs.ruleForm.validate(async valid => {
                if (valid) {
                    ...
                    let issucc = await this.reqData(api.sys.eventCategory, this.form, this.requestType);
                    if (issucc) {
        ...
        async handleDelete(row) {
            ...
            let message = await this.deleteRequestData(api.sys.eventCategory, ids);
