        ...
        children: [
            {
                ...
                name: 'patients',
                meta: { title: '病人信息', icon: 'icon', noCache: true }
            }
        ]
    },
    {
        ...
        children: [
            {
                ...
                name: 'doctor',
                meta: { title: '医生信息', icon: 'icon', noCache: true }
            }
        ]
    },
    {
        ...
        children: [
            {
                ...
                name: 'sickbed',
                meta: { title: '病床信息', icon: 'icon', noCache: true }
            }
        ]
    },
    {
        ...
        children: [
            {
                ...
                name: 'item',
                meta: { title: '项目信息', icon: 'icon', noCache: true }
            }
        ]
    },
    {
        ...
        children: [
            {
                ...
                name: 'notes',
                meta: { title: '重要事项', icon: 'icon', noCache: true }
            }
        ]
    },
        ...
        children: [
            {
                ...
                name: 'basedata',
                meta: { title: '基础数据', icon: 'icon', noCache: true }
            }
        ]
    },
        ...
        children: [
            {
                ...
                name: 'sysuser',
                meta: { title: '人员管理', icon: 'icon', noCache: true }
            }, {
                path: 'sysrole',
