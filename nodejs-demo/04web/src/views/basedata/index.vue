            ...
            <el-tab-pane name="list">
                ...
                <el-form :inline="true" :model="QueryParam" class="demo-form-inline">
                    ...
                    <el-form-item>
                        ...
                        <el-button @click="handleEdit({parentId:0}, 'post')" icon="el-icon-edit"></el-button>
                ...
                <el-table
                    ...
                    style="width: 100%"
                    row-key="id"
                    :tree-props="{children: 'optionValues'}"
                    header-row-class-name="table-header-color"
                    @selection-change="handleSelectionChange"
                >
                    <el-table-column type="selection" width="42"></el-table-column>
                    <el-table-column prop="name" label="数据值" show-overflow-tooltip></el-table-column>
                    ...
                    <el-table-column label="操作" width="260" fixed="right">
                        <template slot-scope="scope">
                            ...
                            <el-button size="mini" type="text" v-if="scope.row.parentId == 0" @click="handleEdit(scope.row, 'post', 'child')">添加子项目</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </el-tab-pane>
...
<script>
import { GetHeight, deleteRequestData, ErrorLog, DeepCopy } from "@/utils/sys";
...
export default {
    data() {
        return {
            actionTabs: 'list',
            tableHeight: GetHeight(220), // 列表高度       
            QueryParam: {},
            tableData: [],
            tableDataTemp: [],
    ...
    methods: {
        ...
        query(flag) {
            ...
            this.$http.get(api.sys.options).then(res => {
            ...
            this.$refs.ruleForm.validate(valid => {
                if (valid) {
                    ...
                    if (this.requestType == "post") {
                        this.$http.post(api.sys.option, this.form).then(res => {
                        ...
                        this.$http.put(api.sys.option, this.form).then(res => {
                            this.dialogValue = false;
                            this.$message.success(res.data.message);
                            this.query();
                        }).catch(err => {
        ...
        async handleDelete(row) {
            ...
            let message = await this.deleteRequestData(api.sys.option, ids);
